...
namespace XParser
{
    ...
    //cmethods-> sectionTitle, (paragraph|subSectionTitle|figure|list|table){1 or multiple time }, pageRange
    ...
    //cmethods -> sectionTitle, (paragraph){1 or  multiple time}, pageRange
    {
