...
namespace XParser
{
    ...
    //cintro -> sectionTitle, (paragraph|subSectionTitle|figure|list|table){1 or  multiple time}, pageRange
    ...
    //cintro -> sectionTitle, (paragraph){1 or  multiple time}, pageRange
    {
