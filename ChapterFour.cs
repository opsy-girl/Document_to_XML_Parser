...
namespace XParser
{
    ...
    //ccontrb-> sectionTitle, (paragraph|subSectionTitle|figure|list|table){1 or multiple time }, pageRange
    ...
    //ccontrb -> sectionTitle, (paragraph){1 or  multiple time}, pageRange
    {
